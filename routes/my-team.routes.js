...
const {
	sendAccessRequest
} = require('../controllers/account-setting/my-team/send-access-request.controller');
...
myTeamRouter.put(
	...
	authenticateJWT,
	authorizeRole(['CRM_USER', 'CRM_ADMIN']),
	removeAccessFromMyTeam
);
myTeamRouter.put(
	'/change-access-request-status/:id',
	authenticateJWT,
	authorizeRole(['CRM_USER', 'CRM_ADMIN']),
	changeAccessRequestStatus
);
myTeamRouter.put(
	'/remove-access-request-by-agent-supervisor',
	authenticateJWT,
	authorizeRole(['CRM_USER', 'CRM_ADMIN']),
	removeMyTeamAccessRequestByAgentOrSupervisor
);
